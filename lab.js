...
/*
  Using an if statement and a comparison operator, create code that will check if Amy and Brittani were born in the same year. If they were, 
  console.log 'Amy & Brittani were born in the same year'. If they were not, console.log 'Amy & Brittani were not born in the same year'
*/
...
if (temperature >= 80 && rain === true) {
  ...
  console.log("You should wear a rain-jacket and take an umbrella.")

}    else if(temperature < 60) {
  console.log("You should wear a jacket and take an umbrella!")

} else {
      console.log("No umbrella is needed today!")
}

// >= 80 and raining - t-shirt and umbrella
// > 60 < 80 and raining - jacket and umbrella
...
/*
  Create a for-loop that runs 10 times, logging the numbers 1 through 10. Ex, on the first iteration it would log 1, on the second iteration 
  it would log 2.
*/
